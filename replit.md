...
- **آخر تحديث**: 30 أكتوبر 2025 - 10:15 UTC (خيار التقاط فوري)
...
#### التحديث #8: إضافة خيار التقاط فوري (10:15 UTC)
**السبب**: بناءً على طلب المستخدم
**التغيير**: 
- ✅ إضافة خيار "**فوري (أسرع)**" إلى قائمة فترات الالتقاط التلقائي
- ✅ الفترة: 1 ميلي ثانية (أسرع ما يمكن)
- ✅ مثالي لجمع صور كثيرة جداً في وقت قصير

**الخيارات المتاحة الآن**:
1. **فوري (أسرع)** - جديد! ⚡
2. 0.1 ثانية (10 صور/ثانية)
3. 0.5 ثانية
4. 1 ثانية (افتراضي)
5. 1.5 ثانية
6. 2 ثانية
